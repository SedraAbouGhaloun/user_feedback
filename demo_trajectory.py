...
def main():
    ...
    traj_min_jerk.plot()
    traj_min_jerk.savetxt("traj_from_min_jerk.txt")
    ...
    traj.plot()
    traj.savetxt("traj_from_polynomial.txt")
    ...
    traj.savetxt("traj_from_viapoint_polynomial.txt")
    ...
    axs[0].legend()
    traj.savetxt("traj_noisy_traj_min_jerk.txt")
