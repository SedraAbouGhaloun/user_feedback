...
class LearningSession:
    ...
    def plot_learning_curve(self, ax=None):
        ...
        # [costs.extend(self.get_sample_costs(i_update)) for i_update in range(self.get_n_updates())]
        ...
        for i_update in range(self.get_n_updates()):
            ...
            costs.append(sample_costs.sum()) # Only include sum
            # costs.append(sample_costs[0])
